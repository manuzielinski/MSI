...
<head>
  ...
  <title>Clases Privadas - UnderTango Club</title>
  <link rel="stylesheet" href="../assets/css/clases-privadas.css">
  <link rel="stylesheet" href="../assets/css/footer.css">
  <link rel="stylesheet" href="../assets/css/navbar.css">
  <link rel="icon" type="image/x-icon" href="../assets/images/favicon.ico">
  <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400..700&family=Chewy&display=swap" rel="stylesheet">
...
<body>
  ...
  <section class="class-info" id="classes">
    <div class="container">
      <h2 class="class-info-title">Atención Personalizada</h2>
      <p class="class-info-text">
        Ajustamos las clases a tus necesidades y ritmo, para que puedas avanzar a tu propio paso y alcanzar tus objetivos. La dirección es Avenida 3 Fronteras 454, Cabaña de los Muñecos.
      </p>
  ...
  <section class="benefits" id="benefits">
    <div class="container">
      <h2 class="benefits-title">Beneficios de las Clases Privadas</h2>
  ...
  <footer>
    <div class="footer-content">
      <div class="footer-section">
        <h3>Contacto</h3>
        <p>Email: undertangoclub@gmail.com</p>
        <p>Teléfono: +54 9 3757 61-8270</p>
      </div>
      <div class="footer-section">
        <h3>Clases</h3>
        <ul>
          <li><a href="#classes">Clases Privadas</a></li>
      ...
      <div class="footer-section">
        ...
        <div class="social-icons">
          <a href="https://wa.me/+5493757618270" target="_blank"><i class="fab fa-whatsapp"></i></a>
          <a href="https://www.instagram.com/undertangoclub/?hl=es" target="_blank"><i class="fab fa-instagram"></i></a>
          <a href="https://www.linkedin.com/company/undertangoclub/posts/?feedView=all" target="_blank"><i class="fab fa-linkedin"></i></a>
        </div>
      </div>
    </div>
